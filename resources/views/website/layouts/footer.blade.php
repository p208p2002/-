	...
	<div class="w-100">
		<div class="row">
			<div class="col-12 col-lg-4 text-center">
				<img class="footer-logo" src="http://aeit.nutc.edu.tw/images/NUTC.png" alt="Generic placeholder image">
			</div>
			<div class="col-12 col-lg-4 text-center">
				<img class="footer-logo" src="http://aeit.nutc.edu.tw/images/NCUT.png" alt="Generic placeholder image">
			</div>
			<div class="col-12 col-lg-4 text-center">
				<img class="footer-logo" src="http://aeit.nutc.edu.tw/images/PU.png" alt="Generic placeholder image">
			</div>
		</div>
		<br>
